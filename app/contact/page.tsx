...
const contactInfo = [
    ...
    {
        icon: <MdWhatsapp className="text-xl" />,
        label: "Whatsapp",
        value: "+260973657684",
        href: "https://wa.me/260973657684",
    },
    {
        icon: <MdOutlineEmail className="text-xl" />,
        label: "Email",
        value: "Stewardshipdivine@gmail.com",
        href: "mailto:Stewardshipdivine@gmail.com",
    },
    {
        icon: <MdOutlineLocationOn className="text-xl" />,
        label: "Location",
        value: "KG 582 street Unit 14 Gasabo Kigali- Rwanda",
        href: "https://maps.app.goo.gl/Z8mZBR6g5oR6NKHC8",
    },
];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="w-full rounded-2xl overflow-hidden border border-gray-200 aspect-[4/3]">
                            <iframe
                                title="MB&U Location — KG 582 street Unit 14 Gasabo Kigali- Rwanda"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4627.312792954311!2d30.082795585284405!3d-1.9341639675249682!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19dca6ba3cb2b105%3A0x67b9a1f7586cf141!2sKG%20582%20St%2C%20Kigali!5e1!3m2!1sen!2srw!4v1771345524913!5m2!1sen!2srw" 
                                width="100%"
                                height="100%"
